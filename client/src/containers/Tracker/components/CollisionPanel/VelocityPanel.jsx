...
import { ToggleForce } from 'src/containers/Toolbox/reducer'
...
function VelocityPanel({ data, pointData, showForce }) {
  const dispatch = useDispatch()
  const toggleForce = () => dispatch(ToggleForce())
